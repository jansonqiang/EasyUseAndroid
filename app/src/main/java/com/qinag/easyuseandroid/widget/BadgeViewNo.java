package com.qinag.easyuseandroid.widget;
 ...
 * @author Jeff Gilfelt
 */
public class BadgeViewNo extends TextView {
    ...
    public BadgeViewNo(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public BadgeViewNo(Context context, AttributeSet attrs) {
     ...
     */
    public BadgeViewNo(Context context, View target) {
     ...
     */
    public BadgeViewNo(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public BadgeViewNo(Context context, AttributeSet attrs, int defStyle) {
