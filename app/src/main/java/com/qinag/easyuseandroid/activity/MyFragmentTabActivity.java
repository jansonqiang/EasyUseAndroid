...
public class MyFragmentTabActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView tagView = ButterKnife.findById(indicator, R.id.tab_mes);
        mBvNotice = setBadgeView(tagView);
        mBvNotice.show();
    ...
    private BadgeView setBadgeView(TextView tagView) {
        ...
        BadgeView badgeView = new BadgeView(this, tagView);



        mBvNotice = new BadgeView(this, tagView);
